package fr.pacman.database.validation.nommage.ui.handlers;
...
import fr.pacman.database.validation.nommage.ui.generators.ValidationUIGenerators;

/**
 * Lanceur pour la demande de validation d'un modèle database.
 * 
 * @author MINARM
 */
